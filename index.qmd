...
- Want to derive a prior for the adverse event (AE) rate $\pi^{*}$ in the control arm of an ongoing blinded trial
...
#| fig-cap: "Example blinded trial analysis"
#| echo: true
#| code-fold: true
#| code-summary: "Julia code"
...
- Official Software Engineering working group of 
